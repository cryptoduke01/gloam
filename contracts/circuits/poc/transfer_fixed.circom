...
template Transfer(levels) {
    ...
    // FIX (Kensho C2): range-check every amount to < 2^128 so the field
    // cannot wrap. Without these, amountPay+amountChange overflows mod r.
    component rc0 = Num2Bits(128); rc0.in <== amountIn;
    component rc1 = Num2Bits(128); rc1.in <== amountPay;
    component rc2 = Num2Bits(128); rc2.in <== amountChange;
