...
**Status:** circuit compiled · dev zkey in `app/public/circuits/sealed_swap*` · settlement **live** on RH testnet Poseidon vault `0xAc25…aF1c` with sealed swap verifiers (see `deployments/poseidon-testnet.json`).
