...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" updated="July 14, 2026">
      ...
      <h2 className="font-display text-2xl text-white">1. Information we may collect</h2>
      <p>
        <strong className="text-white">Wallet data.</strong> Public addresses you
        connect, chain IDs, and transaction hashes you initiate through our
        interfaces.
      </p>
      <p>
        <strong className="text-white">Usage data.</strong> Pages viewed, referrers,
        approximate location derived from IP, device/browser type, and
        diagnostics if you enable analytics cookies.
      </p>
      <p>
        <strong className="text-white">Communications.</strong> Messages you send
      ...
      <h2 className="font-display text-2xl text-white">2. On-chain data</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-white">3. How we use information</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-white">4. Cookies</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-white">5. Sharing</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-white">8. International transfers</h2>
      <p>
        Services may be hosted in multiple regions. By using them, you
        understand information may be processed outside your country.
      </p>
      <h2 className="font-display text-2xl text-white">9. Your choices</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-white">10. Children</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-white">11. Changes</h2>
      <p>
        We may update this Policy by posting a new version with a revised date.
      </p>
      <h2 className="font-display text-2xl text-white">12. Contact</h2>
      <p>
        Privacy questions:{" "}
