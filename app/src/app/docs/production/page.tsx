...
export default function DocsProductionPage() {
  return (
    ...
    >
      ...
      <p>
        The app proves unshield and private send in the browser. That is real
        cryptography — and still <strong>not</strong> production-safe while the
        proving keys come from a development trusted setup.
      </p>
      ...
      <ul>
        ...
        <li>Phase-2 contributions for unshield + transfer circuits with public logs</li>
      ...
      <ul>
        ...
        <li>Honest product copy: vault trade adapter ≠ sealed-size trade</li>
      </ul>
      ...
      <ul>
        <li>
          ...
          hide swap size, not just hold/move
        </li>
