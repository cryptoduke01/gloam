...
export default function CookiesPage() {
  return (
    <LegalLayout title="Cookie Policy" updated="July 14, 2026">
      ...
      <h2 className="font-display text-2xl text-foreground">Your preferences</h2>
      <CookiePreferences />
      ...
      <h2 className="font-display text-2xl text-foreground">Cookies we use</h2>
      <p>
        <strong className="text-foreground">Essential.</strong> Required for security,
      ...
      <p>
        <strong className="text-foreground">Analytics (optional).</strong> If you
      ...
      <h2 className="font-display text-2xl text-foreground">Managing cookies</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Local storage</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Updates</h2>
      <p>
        We may revise this Policy as the product evolves. The “Last updated”
        date will change when we do.
      </p>
      <h2 className="font-display text-2xl text-foreground">More information</h2>
      <p>
        See our{" "}
