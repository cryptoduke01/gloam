...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Use" updated="July 14, 2026">
      ...
      <h2 className="font-display text-2xl text-foreground">1. Experimental software</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">3. Not financial advice</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">4. Wallets and keys</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">5. Privacy features</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">6. Prohibited use</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">7. Third-party services</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">8. Intellectual property</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">9. Disclaimers</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">11. Indemnity</h2>
      <p>
