...
export default function DisclosuresPage() {
  return (
    <LegalLayout title="Disclosures" updated="July 14, 2026">
      ...
      <h2 className="font-display text-2xl text-foreground">Risk of loss</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Smart contract & protocol risk</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Privacy is not absolute</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Regulatory uncertainty</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">No custody</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Third-party & chain risk</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Interface only</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-foreground">Forward-looking statements</h2>
      <p>
        Roadmaps, “coming soon” features, and testnet plans are aspirational.
        Nothing obligates us to ship any feature on any timeline.
      </p>
      <h2 className="font-display text-2xl text-foreground">Related documents</h2>
      <p>
