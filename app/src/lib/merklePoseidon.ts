/**
 * Poseidon incremental Merkle tree — matches
 * IncrementalMerkleTreePoseidon.sol + unshield.circom MerkleTreeChecker.
 */

import { fieldToHex, poseidon2, toField } from "./poseidon";
